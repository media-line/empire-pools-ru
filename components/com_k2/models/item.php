...
class K2ModelItem extends K2Model
{
	...
	function prepareItem($item, $view, $task)
	{
		...
		*/
		if (JFile::exists(JPATH_SITE.DS.'media'.DS.'k2'.DS.'items'.DS.'cache'.DS.md5("Image".$item->id).'_XS.png')){
			$item->imageXSmall = JURI::base(true).'/media/k2/items/cache/'.md5("Image".$item->id).'_XS.png';
			if($params->get('imageTimestamp')){
				$item->imageXSmall.=$timestamp;
			}
		}
		...
		if (JFile::exists(JPATH_SITE.DS.'media'.DS.'k2'.DS.'items'.DS.'cache'.DS.md5("Image".$item->id).'_S.png')){
			$item->imageSmall = JURI::base(true).'/media/k2/items/cache/'.md5("Image".$item->id).'_S.png';
			if($params->get('imageTimestamp')){
				$item->imageSmall.=$timestamp;
			}
		}
		...
		if (JFile::exists(JPATH_SITE.DS.'media'.DS.'k2'.DS.'items'.DS.'cache'.DS.md5("Image".$item->id).'_M.png')){
			$item->imageMedium = JURI::base(true).'/media/k2/items/cache/'.md5("Image".$item->id).'_M.png';
			if($params->get('imageTimestamp')){
				$item->imageMedium.=$timestamp;
			}
		}
		...
		if (JFile::exists(JPATH_SITE.DS.'media'.DS.'k2'.DS.'items'.DS.'cache'.DS.md5("Image".$item->id).'_L.png')){
			$item->imageLarge = JURI::base(true).'/media/k2/items/cache/'.md5("Image".$item->id).'_L.png';
			if($params->get('imageTimestamp')){
				$item->imageLarge.=$timestamp;
			}
		}
		...
		if (JFile::exists(JPATH_SITE.DS.'media'.DS.'k2'.DS.'items'.DS.'cache'.DS.md5("Image".$item->id).'_XL.png')){
			$item->imageXLarge = JURI::base(true).'/media/k2/items/cache/'.md5("Image".$item->id).'_XL.png';
			if($params->get('imageTimestamp')){
				$item->imageXLarge.=$timestamp;
			}
		}
		...
		if (JFile::exists(JPATH_SITE.DS.'media'.DS.'k2'.DS.'items'.DS.'cache'.DS.md5("Image".$item->id).'_Generic.png')){
			$item->imageGeneric = JURI::base(true).'/media/k2/items/cache/'.md5("Image".$item->id).'_Generic.png';
			if($params->get('imageTimestamp')){
				$item->imageGeneric.=$timestamp;
			}
		}
	...
	function prepareFeedItem(&$item)
	{
		...
		*/
		if ($params->get('feedItemImage') && JFile::exists(JPATH_SITE.DS.'media'.DS.'k2'.DS.'items'.DS.'cache'.DS.md5("Image".$item->id).'_'.$params->get('feedImgSize').'.png')){
			$item->description.= '<div class="K2FeedImage"><img src="'.JURI::base(true).'/media/k2/items/cache/'.md5('Image'.$item->id).'_'.$params->get('feedImgSize').'.png" alt="'.$item->title.'" /></div>';
		}
		//-----------------------------
