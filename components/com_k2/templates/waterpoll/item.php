...
$txt = $this->item->fulltext;
$re = '/<div class=\"first_info\">(.*?)<\\/div>/si';
//echo $match[1];
preg_match($re, $txt, $matches);
$first_info = $matches[0];
$this->item->fulltext = preg_replace($re, '', $this->item->fulltext);
...
$img_arr = array();
preg_match('/<img[^>]+>/i', $this->item->fulltext, $img_arr);
...
$this->item->fulltext = $add_info . preg_replace('/<img[^>]*>/', '', $this->item->fulltext);
  ...
  <div class="itemBody bassein">
	  ...
	  <?php echo $this->item->event->K2BeforeDisplayContent; ?>
			...
			<tr>
				...
				<td>
				  ...
				  <div class="itemImageBlock">
					  ...
					  <span class="itemImage">
						<!--		  	<a class="modal" rel="{handler: 'image'}" href="<?php echo $additional_img_src; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">-->
							<img src="<?php echo $additional_img_src; ?>"  style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" />
						<!--</a>-->
					  </span>
					  ...
					  <?php endif; ?>
					<?//	<a href="<? echo JRoute::_('index.php?Itemid=114&tmpl=component') ?1>" class="blue_button fansybox"><span>Подобрать цвет</span></a>	?>
					  <div class="clr"></div>
				  </div>
				  <?php endif; ?>
				</td>
       ...
       <?php jimport( 'joomla.application.module.helper' );
        $modules = JModuleHelper::getModules('pool_before_content'); 
        $attribs['style'] = 'xhtml';
        ...
        switch ($this->item->id) {
            case 13: 
                $positionPool = 'model_florentciia_before_content';
                break;
            case 12: 
                $positionPool = 'model_hilton_before_content';
                break;
            case 11: 
                $positionPool = 'model_kontinent_before_content';
                break;
            case 10: 
                $positionPool = 'model_malibu_before_content';
                break;
            case 9: 
                $positionPool = 'model_malta_before_content';
                break;
            case 8: 
                $positionPool = 'model_liuksor_before_content';
                break;
            case 4: 
                $positionPool = 'model_reddison_before_content';
                break;
            case 3: 
                $positionPool = 'model_spa_before_content';
                break;
            case 2: 
                $positionPool = 'model_san_before_content';
                break;
            case 1: 
                $positionPool = 'model_kupel_before_content';
                break;
        } ?>
        
        <?php jimport( 'joomla.application.module.helper' );
        $modules = JModuleHelper::getModules($positionPool); 
        $attribs['style'] = 'xhtml';
