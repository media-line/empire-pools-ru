...
//print_r();
$this->item->fulltext = preg_replace('/<img[^>]*>/', '', $this->item->fulltext);
  ...
  <div class="catItemBody">
	...
	<div class="catItemHeader">
	  ...
	  <h3 class="catItemTitle">
	  	...
	  	<?php endif; ?>
		<span><?=$this->item->extra_fields[0]->value?></span>
	  </h3>
	  <?php endif; ?>
			...
			<tr>
				<td>
					<a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
						<!--<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" /><br />-->
						<img src="<?php echo $additional_img_src; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" />
					</a>
				</td>
			</tr>
		</table>
	  ...
	  <?php endif; ?>
		...
		<div class="catItemInfoBlock">
			<table>
				<tr>
					<td class="catItemIntroText">
						<?php echo $this->item->introtext; ?>					
					</td>
					<td class="catItemReadMore">
						<a class="k2ReadMore blue_btn" href="<?php echo $this->item->link; ?>"><span>Далее</span></a>
					</td>
				</tr>
			</table>
		</div>
