...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
 ...
 <?php if($this->item->params->get('catItemExtraFields') && count($this->item->extra_fields)): ?>
	  ...
	  <div class="catItemExtraFields2">
	  	...
	  	<ul>
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; ?> type<?php echo ucfirst($extraField->type); ?> group<?php echo $extraField->group; ?>">
				...
				<?php if($extraField->value == '5') echo print'<img src="images/5-stars.png">' ?>                
                <?php if($extraField->value == '4') echo print'<img src="images/4-stars.png">' ?>
			    <?php if($extraField->value == '3') echo print'<img src="images/3-stars.png">' ?>
                <?php if($extraField->value == '2') echo print'<img src="images/2-stars.png">' ?>
                <?php if($extraField->value == '1') echo print'<img src="images/1-stars.png">' ?>
  ...
  <div class="catItemBody2">
	  ...
	  <!-- Item Image -->
	  <div class="catItemImageBlock1">
		  <span class="catItemImage1">
