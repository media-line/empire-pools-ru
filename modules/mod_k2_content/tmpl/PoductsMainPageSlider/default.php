...
//public_html/modules/mod_k2_content/tmpl/PoductsMainPageSlider
?>
...
<?
//echo'<pre>';print_r($items[0],0);echo'</pre>';
?>
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul class="pools-slick">
    <?php foreach ($items as $key=>$item):	?>
    <li>
	<a class="moduleItemFull" href="<?php echo $item->link; ?>">
				...
				<td class="img">
					<?php if($params->get('itemImage') && isset($item->image)): ?>
						<a class="moduleItemImage" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
							<?
								$item->image = str_replace('cache','src',$item->image);
								$item->image = str_replace('_S','',$item->image);
							?>
				...
				<td>
					<div class="moduleItemIntrotext">
						...
						<?php if($params->get('itemReadMore') && $item->fulltext): ?>
							<a class="moduleItemReadMore" href="<?php echo $item->link; ?>"><span>Далее</span></a>
						<?php endif; ?>
